...
print(len(glob.glob(root+'*/*/*/into_future/*/*.pfm'))*2)
...
# with open("datasets/FlyingThings3D/optical_flow/flow_mag.json", "w") as json_file:
#     json.dump(flow_mag_dict, json_file)